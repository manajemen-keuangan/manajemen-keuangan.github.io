...
background-color:#184e8e;">
    <div class="text-white d-md-flex align-items-center h-100 p-5 text-center justify-content-center d-none d-sm-block">
        <div class="logoarea pt-5 pb-5">
          ...
          <p class="mb-0">Waktu adalah kunci untuk membangun keamanan finansial Anda.</p>
          <footer class="blockquote-footer">Suze Orman</footer>
        </blockquote>
        </div>
    </div>
</div>
...
<div class="col-md-6 p-0 bg-white h-md-100 loginarea">
    <div class="d-md-flex align-items-center h-md-100 p-5 justify-content-center">
      <div class="col-md-6">
        <h1 class="display-4 txt-center">Lupa Kata Sandi</h1>
        <p class="lead d-none d-sm-block" style="text-align: center;">SIlahkan masukan email yang digunakan</p>
